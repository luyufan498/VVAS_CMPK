...
################################################################
# This is a generated script based on design: bd_f080
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_INCLUDE_PIXEL_REPEAT {1} \
  ...
  connect_bd_net -net net_v_hdmi_tx_bridge_pixel_repeat [get_bd_pins v_axi4s_vid_out/repeat_en] [get_bd_pins v_hdmi_tx/bridge_pixel_repeat]
